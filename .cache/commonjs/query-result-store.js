		...
		window._gatsbyEvents.push([
			`FAST_REFRESH`,
			{
				...
				payload:
					...
					_this$state === void 0
						? void 0
						: (_this$state$page = _this$state.page) === null ||
						  _this$state$page === void 0
						? void 0
						: (_this$state$page$page = _this$state$page.page) ===
								null || _this$state$page$page === void 0
						? void 0
						: _this$state$page$page.getServerDataError,
			},
		]);
	}
	...
	componentDidUpdate() {
		...
		window._gatsbyEvents.push([
			`FAST_REFRESH`,
			{
				action: `SHOW_GETSERVERDATA_ERROR`,
				payload:
					(_this$state2 = this.state) === null ||
					_this$state2 === void 0
						? void 0
						: (_this$state2$page = _this$state2.page) === null ||
						  _this$state2$page === void 0
						? void 0
						: (_this$state2$page$pag = _this$state2$page.page) ===
								null || _this$state2$page$pag === void 0
						? void 0
						: _this$state2$page$pag.getServerDataError,
			},
		]);
	}
