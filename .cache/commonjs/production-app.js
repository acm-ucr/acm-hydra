...
(0, _apiRunnerBrowser.apiRunnerAsync)(`onClientEntry`).then(() => {
	...
	// to return true.
	if (
		(0, _apiRunnerBrowser.apiRunner)(`registerServiceWorker`).filter(
			Boolean
		).length > 0
	) {
				...
				({ location }) =>
					/*#__PURE__*/ _react.default.createElement(
						...
						({ pageResources, location }) => {
							const staticQueryResults = (0,
							_loader.getStaticQueryResults)();
							return /*#__PURE__*/ _react.default.createElement(
					...
					/*#__PURE__*/ _react.default.createElement(
						...
						/*#__PURE__*/ _react.default.createElement(
							_gatsbyReactRouterScroll.ScrollContext,
							{
								location: location,
								shouldUpdateScroll:
									_navigation.shouldUpdateScroll,
							},
							/*#__PURE__*/ _react.default.createElement(
								_reachRouter.Router,
								{
	...
	_loader.publicLoader
		.loadPage(browserLoc.pathname + browserLoc.search)
		.then(page => {
			var _page$page;
			...
			if (
				page !== null &&
				page !== void 0 &&
				(_page$page = page.page) !== null &&
				_page$page !== void 0 &&
				_page$page.webpackCompilationHash &&
				...
				if (sessionStorage) {
					const isReloaded =
						sessionStorage.getItem(reloadStorageKey) === `1`;
