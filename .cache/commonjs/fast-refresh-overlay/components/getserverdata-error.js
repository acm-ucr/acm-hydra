...
function GetServerDataError({ error }) {
	var _error$context;
	...
	const filePath = `./${
		filePathRegex.exec(
			info === null || info === void 0 ? void 0 : info.fileName
		)[1]
	}`;
	const lineNumber =
		info === null || info === void 0 ? void 0 : info.lineNumber;
	const columnNumber =
		info === null || info === void 0 ? void 0 : info.columnNumber;
	const name =
		(info === null || info === void 0 ? void 0 : info.functionName) ===
	...
	return /*#__PURE__*/ React.createElement(
		...
		/*#__PURE__*/ React.createElement(
			...
			/*#__PURE__*/ React.createElement(
				...
				/*#__PURE__*/ React.createElement("span", null, filePath)
			),
		...
		/*#__PURE__*/ React.createElement(
			_overlay.Body,
			null,
			/*#__PURE__*/ React.createElement("h2", null, "Error Message"),
			/*#__PURE__*/ React.createElement(
				"p",
				{
				...
				error === null || error === void 0
					? void 0
					: (_error$context = error.context) === null ||
					  _error$context === void 0
					? void 0
					: _error$context.sourceMessage
			),
