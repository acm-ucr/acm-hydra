...
function WrappedAccordionItem({ error, open }) {
	var _error$error,
		_error$location,
		_error$location$start,
		_error$location2,
		_error$location2$star;
	...
	const filePath =
		error === null || error === void 0 ? void 0 : error.filePath;
	const lineNumber =
		error === null || error === void 0
			? void 0
			: (_error$location = error.location) === null ||
			  _error$location === void 0
			? void 0
			: (_error$location$start = _error$location.start) === null ||
			  _error$location$start === void 0
			? void 0
			: _error$location$start.line;
	const columnNumber =
		error === null || error === void 0
			? void 0
			: (_error$location2 = error.location) === null ||
			  _error$location2 === void 0
			? void 0
			...
			/*#__PURE__*/ React.createElement(
				...
				/*#__PURE__*/ React.createElement(
					"button",
					{
						...
						onClick: () =>
							(0, _utils.openInEditor)(filePath, lineNumber),
					},
					"Open in Editor"
				)
			),
