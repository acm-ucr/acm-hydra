...
exports.modules = {
		...
		/***/ (
			...
			var getLocation = function getLocation(source) {
				...
				return {
					...
					key:
						(source.history.state && source.history.state.key) ||
						"initial",
				};
			};
					...
					navigate: function navigate(to) {
						...
						if (typeof to === "number") {
							...
							try {
								...
								source.location[replace ? "replace" : "assign"](
									to
								);
							}
						}
				...
				var initialLocation = {
					pathname:
						searchIndex > -1
							...
							: initialPath,
					search:
						searchIndex > -1 ? initialPath.substr(searchIndex) : "",
				};
				var index = 0;
  ...
  \*************************************************************/
		/***/ (
			...
			__webpack_require__.r(__webpack_exports__);
			/* harmony export */ __webpack_require__.d(__webpack_exports__, {
				/* harmony export */ insertParams: () =>
					/* binding */ insertParams,
			...
			var insertParams = function insertParams(path, params) {
				...
				var _params$location$sear = _params$location.search,
					search =
						_params$location$sear === undefined
							? ""
							: _params$location$sear;
		...
		/***/ module => {
			...
			module.exports = function (obj, predicate) {
				...
				for (var i = 0; i < keys.length; i++) {
					...
					if (
						isArr
							? predicate.indexOf(key) !== -1
							: predicate(key, val, obj)
					) {
						ret[key] = val;
					}
				}
  ...
  \*******************************************/
		/***/ (__unused_webpack_module, exports, __webpack_require__) => {
			...
			var _isLocalLink = __webpack_require__(
				/*! ./is-local-link */ "./node_modules/gatsby-link/is-local-link.js"
			);

			var _rewriteLinkPath = __webpack_require__(
				/*! ./rewrite-link-path */ "./node_modules/gatsby-link/rewrite-link-path.js"
			);
			...
			var GatsbyLink = /*#__PURE__*/ (function (_React$Component) {
				...
				_proto._prefetch = function _prefetch() {
					var currentPath =
						window.location.pathname + window.location.search; // reach router should have the correct state
					...
					var rewrittenPath = (0, _rewriteLinkPath.rewriteLinkPath)(
						this.props.to,
						currentPath
					);
				...
				_proto.handleRef = function handleRef(ref) {
					...
					if (this.state.IOSupported && ref) {
						...
						this.io = createIntersectionObserver(
							ref,
							function (inViewPort) {
								if (inViewPort) {
				...
				_proto.render = function render() {
					...
					var prefixedTo = (0, _rewriteLinkPath.rewriteLinkPath)(
						to,
						_location.pathname
					);
						...
						(0, _extends2.default)(
							{
								...
								onMouseEnter: function onMouseEnter(e) {
									...
									var parsed = (0, _parsePath.parsePath)(
										prefixedTo
									);
			...
			GatsbyLink.propTypes = (0, _extends2.default)(
				{},
				NavLinkPropTypes,
				{
			...
			var navigate = function navigate(to, options) {
				window.___navigate(
					(0, _rewriteLinkPath.rewriteLinkPath)(
						to,
  ...
  \*******************************************************/
		/***/ (__unused_webpack_module, exports, __webpack_require__) => {
			...
			var _applyTrailingSlashOption = __webpack_require__(
				/*! gatsby-page-utils/apply-trailing-slash-option */ "./node_modules/gatsby-page-utils/dist/apply-trailing-slash-option.js"
			);

			var _parsePath2 = __webpack_require__(
				/*! ./parse-path */ "./node_modules/gatsby-link/parse-path.js"
			);
			...
			var rewriteLinkPath = function rewriteLinkPath(path, relativeTo) {
				...
				if (option === "always" || option === "never") {
					var output = (0,
					_applyTrailingSlashOption.applyTrailingSlashOption)(
						pathname,
						option
					);
  ...
  \****************************************************************************/
		/***/ (__unused_webpack_module, exports) => {
			...
			var applyTrailingSlashOption = function applyTrailingSlashOption(
				input,
				option
			) {
				if (option === void 0) {
			...
			var ScrollHandler = /*#__PURE__*/ (function (_React$Component) {
				...
				function ScrollHandler() {
					...
					_this.scrollToHash = function (hash, prevProps) {
						...
						if (
							node &&
							_this.shouldUpdateScroll(prevProps, _this.props)
						) {
							node.scrollIntoView();
						}
					};

					_this.shouldUpdateScroll = function (
						prevRouterProps,
						routerProps
					) {
				...
				_proto.componentDidMount = function componentDidMount() {
					...
					if (key) {
						scrollPosition = this._stateStorage.read(
							this.props.location,
							key
						);
					}
		...
		/***/ (__unused_webpack_module, exports) => {
			...
			var SessionStorage = /*#__PURE__*/ (function () {
				...
				_proto.getStateKey = function getStateKey(location, key) {
					var stateKeyBase =
						"" + STATE_KEY_PREFIX + location.pathname;
  ...
  \********************************/
		/***/ (
			...
			/* harmony import */ var query_string__WEBPACK_IMPORTED_MODULE_2__ =
				__webpack_require__(
			...
			class Dev404Page extends react__WEBPACK_IMPORTED_MODULE_0___default()
				...
				constructor(props) {
					...
					const pagePaths = data.allSitePage.nodes.map(
						node => node.path
					);
					const urlState =
						query_string__WEBPACK_IMPORTED_MODULE_2__.parse(
							location.search
						);
					...
					this.handlePagePathSearch =
						this.handlePagePathSearch.bind(this);
				...
				setSearchUrl(searchValue) {
					...
					const searchMap =
						query_string__WEBPACK_IMPORTED_MODULE_2__.parse(search);
...
export default function API (req, res) {
  res.json({ hello: "world" })
								...
								this.state.initPagePaths.length > 0 &&
									/*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
										...
										/*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
											...
											null,
											"Functions (",
											this.props.data.allSiteFunction
												.nodes.length,
											")"
										),
										/*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
											"ul",
											null,
											this.props.data.allSiteFunction.nodes.map(
												node => {
			...
			/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
				Dev404Page; // ESLint is complaining about the backslash in regex
  ...
  \*****************************/
		/***/ (
			...
			/* harmony export */ __webpack_require__.d(__webpack_exports__, {
				...
				/* harmony export */ findMatchPath: () =>
					/* binding */ findMatchPath,
				/* harmony export */ findPath: () => /* binding */ findPath,
				/* harmony export */ grabMatchParams: () =>
					/* binding */ grabMatchParams,
				/* harmony export */ setMatchPaths: () =>
					/* binding */ setMatchPaths,
				/* harmony export */
			});
			...
			const findMatchPath = rawPathname => {
				...
				if (path) {
					return (0,
					_normalize_page_path__WEBPACK_IMPORTED_MODULE_2__[
						"default"
  ...
  \****************************************/
		/***/ (
			...
			/* harmony import */ var gatsby_link__WEBPACK_IMPORTED_MODULE_1__ =
				__webpack_require__(
			...
			/* harmony import */ var _public_page_renderer__WEBPACK_IMPORTED_MODULE_3___default =
				/*#__PURE__*/ __webpack_require__.n(
					_public_page_renderer__WEBPACK_IMPORTED_MODULE_3__
				);
			/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_4__ =
				__webpack_require__(/*! ./loader */ "./.cache/loader.js");

			const prefetchPathname =
				_loader__WEBPACK_IMPORTED_MODULE_4__["default"].enqueue;
			...
			const useStaticQuery = query => {
				...
				if (
					typeof react__WEBPACK_IMPORTED_MODULE_0___default()
						.useContext !== `function` &&
...
`);
			...
			StaticQuery.propTypes = {
				...
				query: prop_types__WEBPACK_IMPORTED_MODULE_5___default().string
					.isRequired,
  ...
  \**************************/
		/***/ (
			...
			/* harmony export */ __webpack_require__.d(__webpack_exports__, {
				...
				/* harmony export */ publicLoader: () =>
					/* binding */ publicLoader,
			...
			class BaseLoader {
				...
				setApiRunner(apiRunner) {
					...
					this.prefetchDisabled = apiRunner(
					...
					return this.memoizedGet(url).then(req => {
						...
						if (status === 200) {
							try {
								...
								if (
									maybeSearch &&
									!jsonPayload.path.includes(maybeSearch)
								) {
				...
				findMatchPath(rawPath) {
					return (0,
					_find_path__WEBPACK_IMPORTED_MODULE_2__.findMatchPath)(
						rawPath
					);
						...
						const staticQueryBatchPromise = Promise.all(
							staticQueryHashes.map(staticQueryHash => {
								...
								if (this.staticQueryDb[staticQueryHash]) {
									const jsonPayload =
										this.staticQueryDb[staticQueryHash];
									return {
										staticQueryHash,
										jsonPayload,
									};
							...
							staticQueryResults.forEach(
								({ staticQueryHash, jsonPayload }) => {
									staticQueryResultsMap[staticQueryHash] =
										jsonPayload;
									this.staticQueryDb[staticQueryHash] =
										jsonPayload;
								}
						...
						return Promise.all([
							...
							.then(([pageResources, staticQueryResults]) => {
								...
								if (pageResources) {
									...
									_emitter__WEBPACK_IMPORTED_MODULE_1__[
										"default"
									].emit(`onPostLoadPageResources`, {
										page: payload,
				...
				prefetch(pagePath) {
					...
					abortC.signal.addEventListener(`abort`, () => {
						const index = this.prefetchQueued.findIndex(
							([p]) => p === pagePath
						...
						const prefetches = Promise.all(
							toPrefetch.map(([pagePath, dPromise]) => {
								...
								return this.doPrefetch(
									(0,
									_find_path__WEBPACK_IMPORTED_MODULE_2__.findPath)(
										pagePath
									)
								).then(() => {
					...
					return this.memoizedGet(
						...
						if (status === 200) {
							try {
								...
								if (
									jsonPayload.webpackCompilationHash ===
									undefined
								) {
									throw new Error(
			...
			class ProdLoader extends BaseLoader {
				...
				doPrefetch(pagePath) {
					return super.doPrefetch(pagePath).then(result => {
						...
						return Promise.all(
							componentUrls.map(
								_prefetch__WEBPACK_IMPORTED_MODULE_0__[
									"default"
								]
							)
						).then(() => pageData);
  ...
  \**********************************/
		/***/ (
			...
			function maybeGetBrowserRedirect(pathname) {
				...
				if (!redirect) {
					redirect = redirectIgnoreCaseMap.get(
  ...
  \*********************************************************/
		/***/ (
			...
			/* harmony export */ __webpack_require__.d(__webpack_exports__, {
				...
				/* harmony export */ useLocation: () =>
					/* binding */ useLocation,
				/* harmony export */ useMatch: () => /* binding */ useMatch,
				/* harmony export */ useNavigate: () =>
					/* binding */ useNavigate,
			...
			/* harmony import */ var invariant__WEBPACK_IMPORTED_MODULE_1__ =
				__webpack_require__(
					/*! invariant */ "./node_modules/invariant/invariant.js"
				);
			...
			/* harmony import */ var _lib_history__WEBPACK_IMPORTED_MODULE_4__ =
				__webpack_require__(
			...
			LocationProvider.defaultProps = {
				history:
					_lib_history__WEBPACK_IMPORTED_MODULE_4__.globalHistory,
			};
			true
			...
			var RouterImpl = (function (_React$PureComponent) {
				...
				RouterImpl.prototype.render = function render() {
					...
					var match = (0,
					_lib_utils__WEBPACK_IMPORTED_MODULE_3__.pick)(
						routes,
						pathname
					);
					...
					if (match) {
						...
						var props = _extends({}, params, {
							...
							navigate: function navigate(to, options) {
								return _navigate2(
									(0,
									_lib_utils__WEBPACK_IMPORTED_MODULE_3__.resolve)(
										to,
										uri
									),
									options
			...
			(0, react_lifecycles_compat__WEBPACK_IMPORTED_MODULE_2__.polyfill)(
				FocusHandlerImpl
			);
			...
			////////////////////////////////////////////////////////////////////////////////
			var forwardRef =
				react__WEBPACK_IMPORTED_MODULE_0___default().forwardRef;
						...
						return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
							...
							function (_ref6) {
								...
								var to = props.to,
									...
									getProps =
										_props$getProps === undefined
											? k
											: _props$getProps,
									anchorProps = _objectWithoutProperties(
										props,
								...
								var isCurrent =
									location.pathname === encodedHref;
								var isPartiallyCurrent = (0,
								_lib_utils__WEBPACK_IMPORTED_MODULE_3__.startsWith)(
									location.pathname,
									encodedHref
								);
			...
			true
				? (Link.propTypes = {
						to: prop_types__WEBPACK_IMPORTED_MODULE_5___default()
							.string.isRequired,
				  })
				: 0;
				...
				RedirectImpl.prototype.componentDidMount =
					function componentDidMount() {
						...
						Promise.resolve().then(function () {
							...
							navigate(
								(0,
								_lib_utils__WEBPACK_IMPORTED_MODULE_3__.insertParams)(
									resolvedTo,
									props
								),
			...
			true
				? (Redirect.propTypes = {
						from: prop_types__WEBPACK_IMPORTED_MODULE_5___default()
							.string,
						to: prop_types__WEBPACK_IMPORTED_MODULE_5___default()
							.string.isRequired,
				  })
					...
					function (_ref9) {
						...
						return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(
							...
							function (_ref10) {
								...
								var result = (0,
								_lib_utils__WEBPACK_IMPORTED_MODULE_3__.match)(
									resolvedPath,
									location.pathname
								);
								return children({
			...
			var useLocation = function useLocation() {
				var context = (0,
				react__WEBPACK_IMPORTED_MODULE_0__.useContext)(LocationContext);
			...
			var useNavigate = function useNavigate() {
				var context = (0,
				react__WEBPACK_IMPORTED_MODULE_0__.useContext)(BaseContext);
			...
			var createRoute = function createRoute(basepath) {
				return function (element) {
					...
					!!(
						element.type === Redirect &&
						!(0,
						_lib_utils__WEBPACK_IMPORTED_MODULE_3__.validateRedirect)(
							element.props.from,
							element.props.to
						)
					)
					...
					var path =
						elementPath === "/"
							? basepath
							: stripSlashes(basepath) +
							  "/" +
							  stripSlashes(elementPath);
					...
					case "separator":
						return (key, value, accumulator) => {
							...
							const isEncodedArray =
								typeof value === "string" &&
								!isArray &&
								decode(value, options).includes(
									options.arrayFormatSeparator
								);
							value = isEncodedArray
