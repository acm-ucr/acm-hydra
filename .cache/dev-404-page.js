			...
			<div>
				...
				{newFilePath && (
					<div>
						...
						<p>
							Create a React.js component like the following in
							your site directory at
							{` `}"<code>{newFilePath}</code>"{` `}
							and then refresh to show the new page component you
							created.
						</p>
						<pre
							style={{
  ...
  return "Hello world"
				...
				{newAPIPath && (
					<div>
						...
						<p>
							Create a javascript file like the following in your
							site directory at
							{` `}"<code>{newAPIPath}</code>"{` `}
							and refresh to execute the new API function you
							created.
						</p>
						<pre
							style={{
  ...
  res.json({ hello: "world" })
				...
				{this.state.initPagePaths.length > 0 && (
					<div>
						<hr />
						<p>
							If you were trying to reach another page or
							function, perhaps you can find it below.
						</p>
						<h2>
							Functions (
						...
						<ul>
							...
							{this.state.pagePaths.length > 100 && (
								<p style={{ fontWeight: `bold` }}>
									... and {this.state.pagePaths.length - 100}{" "}
									more.
								</p>
							)}
						</ul>
