describe("board presence check", () => {
	it("passes", () => {
		...
		cy.get(":nth-child(9) > .bg-acm-lightpurple").contains(
			"Noah Snodgrass"
		);
		cy.get(":nth-child(9) > .bg-acm-lightpurple").contains("Treasurer");
		cy.get(":nth-child(10) > .bg-acm-yellow").contains("Kapilan Ramasamy");
		cy.get(":nth-child(10) > .bg-acm-yellow").contains("Marketing");
	});
});
