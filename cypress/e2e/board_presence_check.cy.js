describe("board presence check", () => {
	it("passes", () => {
		...
		cy.get(":nth-child(9) > .bg-acm-lightpurple").contains("Justin Yee");
		cy.get(":nth-child(9) > .bg-acm-lightpurple").contains("Alumni");
		cy.get(":nth-child(10) > .bg-acm-yellow").contains("Noah Snodgrass");
		cy.get(":nth-child(10) > .bg-acm-yellow").contains("Treasurer");
