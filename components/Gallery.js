					...
					<Col className='flex justify-center m-auto w-5/6'>
						<Col>
							<img
								...
								src='image15.png'
							/>
							<img className='p-1' alt='students in a large classroom watching a presentation' src='image14.png' />
						</Col>
						<Col>
							<img
								className='p-1'
								...
								src='image17.png'
							/>
							<img className='p-1' alt='students following along on their laptops in an acm workshop' src='image9.jpg' />
						</Col>
					</Col>
					<Col className='py-2'>
						<img alt='students sitting at tables discussing their ideas with professors' src='image10.jpg' />
					</Col>
				</Row>
				<Row>
					<img className='pt-2 pb-16' alt='students paying attention during an acm meeting' src='image12.png' />
				</Row>
			</Row>
		</Row>
	);
