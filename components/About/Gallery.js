		...
		<section className='py-6 dark:bg-gray-800 dark:text-gray-50'>
			<div className='container grid grid-cols-2 gap-4 p-4 mx-auto md:grid-cols-4'>
				...
				<img
					...
					className='w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square'
          src='https://lh3.googleusercontent.com/pw/AM-JKLWKcRa4bq-Hh5bC53PoFSaB7l9Go00v6BmY4D8DjDq-Hd3-y3lI89lEAWOBLvF5ea7CB-A9c9tk0zLmwWLmfZwLI2PCVU7L81S8SX3TvvQIDLFc9eR_BPSYjJ3XKDTE_wZqgBhvfCDyejsTbJB_3-2_Xg=w1244-h933-no?authuser=0'
				/>
				<img
